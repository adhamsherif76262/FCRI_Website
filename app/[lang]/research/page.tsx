...
import arResearch from '../../../locales/ar/research_Ar.json';
import enResearch from '../../../locales/en/research_En.json';
...
export default function ProductionPage() {
    ...
    const t = currentLang === 'ar' ? arResearch : enResearch;
    // const projectsMeta = getPdfMetaSync(t.Projects_File_PDF_Path);
  ...
  return (
    ...
    <main className="flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 dark:bg-gray-900 transition-colors duration-1000 xxxs:OVERFLOW-X xl:overflow-x-visible">
      <FuturisticHeading rtl={isRTL}>
        {currentLang === 'ar' ? "قطاع البحوث بالمعهد" : "The Institute’s Research Sector"}
      </FuturisticHeading>
      ...
      <div className="mt-16 mb-8 w-full max-w-8xl mx-auto">
        <section className="bg_Beigse bg-green-500 bg-opacity-50 backdrop-blur-sm rounded-3xl px-4 py-8 shadow-xl">
          <div className="flex justify-center">
            <EnhancedCircularImageList Description={t.Description} Title={isRTL ? "اهمية قطاع البحوث بالمعهد" : "The Institute's Research Sector Importance"} data={t.Research_Mission} language={currentLang}></EnhancedCircularImageList>
          </div>
        </section>
      </div>
      ...
      <div className="space-y-10 py-6 xxxs:overflow-hidden xxs:overflow-visible">
        <ClientPDFSection
          title={isRTL ? 'ملف المشاريع' : 'Projects File'}
          pdf={t.Projects_File_PDF_Path}
          isArabic={isRTL}
